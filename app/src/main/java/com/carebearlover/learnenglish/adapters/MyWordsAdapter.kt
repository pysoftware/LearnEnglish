...
class MyWordsAdapter(
        private val listener: (MyWordsEntity) -> Unit,
        application: Application,
        private val navController: NavController
) : RecyclerView.Adapter<MyWordsAdapter.ViewHolder>() {

    private val repository = MyRepository(application)

    private var mWordsList = mutableListOf<MyWordsEntity>()
    private var mWordsListFull= mutableListOf<MyWordsEntity>()

    fun setData(wordsList: List<MyWordsEntity>) {
        mWordsList.clear()
    ...
    fun insert(wordsEntity: MyWordsEntity) {
...
//                    }
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), LayoutContainer {
        ...
        fun bind(model: MyWordsEntity, listener: (MyWordsEntity) -> Unit) {
